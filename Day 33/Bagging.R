...
#mtry means How many of the predictor variables that we want to consider while building a model

test$bagging <- predict(bagging, test)
MSE2bagging <- mean((test$bagging - test$Collection)^2)

#You can clearly see that MSE2bagging is reduced. Less MSE means good model